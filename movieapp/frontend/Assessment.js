...
Includes two forms:
// -One below the average rating with a radio input with options from 1 to 5 stars.
-When a user selects an option and clicks submit, a new Rating should be added to that movie.
-The average rating should immediately change.

// -One above the list of comments with a text input.
-When the user enters text and clicks submit, a new Comment should be added to that movie and rendered above all other Comments.
